        ...
        <div>
          ...
          <div>
            <h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">
              Your best companion for watching anime and reading manga
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600 sm:text-center">
              Find out the most up-to-date information about anime and manga.
              Track, share, and discover your favorite anime and manga here!
            </p>
